...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, principal: Principal):
        ...
        assertions.assert_invalid(assignment.state == AssignmentStateEnum.SUBMITTED, 'only a draft assignment can be submitted')
    ...
    def grading(cls, _id, grade, principal: Principal):
        ...
        assertions.assert_invalid(assignment.state == AssignmentStateEnum.DRAFT, 'assignment which is not submitted cannot be graded')
        assertions.assert_invalid(assignment.state == AssignmentStateEnum.GRADED, 'assignment which is graded cannot be graded again')
